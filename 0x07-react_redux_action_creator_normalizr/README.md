This directory contains all the solutions to the ALX 0x07. React Redux action creator+normalizr project. The tasks are as follows:

## task_0/dashboard/src/schema/notifications.js, task_0/dashboard/src/schema/notifications.test.js
...
## task_1/dashboard/src/schema/notifications.js, task_1/dashboard/src/schema/notifications.test.js
