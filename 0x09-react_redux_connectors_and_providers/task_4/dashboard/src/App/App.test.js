...
import { initialState } from "../reducers/rootReducer"; // Import initial state from rootReducer

const store = createStore(rootReducer, fromJS(initialState)); // Use rootReducer and initialState
